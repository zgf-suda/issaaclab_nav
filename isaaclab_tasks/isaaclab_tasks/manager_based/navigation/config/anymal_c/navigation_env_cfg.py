...
class ActionsCfg:
    ...
    pre_trained_policy_action: mdp.PreTrainedPolicyActionCfg = mdp.PreTrainedPolicyActionCfg(
        ...
        policy_path = f'/home/user/IsaacLab/logs/rsl_rl/unitree_go2_flat/2025-06-26_11-42-18/exported/policy.pt',
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        distance = ObsTerm(func=mdp.distance)
...
class CommandsCfg:
    ...
    pose_command = mdp.UniformPose2dCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(2.5,2.5), pos_y=(-3.0, -3.0), heading=(-math.pi, -math.pi)),
    )
